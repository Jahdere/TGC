...
UPDATE creature_ai_scripts SET action1_param2 = 8 WHERE id = 1780802;
UPDATE creature_ai_scripts SET action1_param2 = 8 WHERE id = 1780804;
...
UPDATE creature_template SET flags_extra = 0 WHERE entry = 17818;
